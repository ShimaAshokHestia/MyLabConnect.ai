...
const consentSections: ConsentSection[] = [
  {
    ...
    content:
      'We collect your name, contact information, and dental records solely to provide you with personalised care. Your data is stored securely on encrypted servers and is never sold to third parties. You may request a copy or deletion of your data at any time by contacting our privacy team.',
  },
  {
    id: 'medical-records',
    ...
    content:
      'By continuing, you authorise {my}labconnect.ai to access and maintain your dental health records, X-rays, treatment plans, and clinical notes within this platform. These records are accessible only to authorised dental professionals involved in your care.',
  },
  {
    id: 'ai-assistance',
    ...
    content:
      'Our platform uses AI to assist dental professionals with pattern recognition, treatment suggestions, and diagnostic support. AI-generated insights are always reviewed by a qualified clinician before any clinical decision is made. You retain the right to opt out of AI-assisted analysis at any time.',
  },
  {
    id: 'communication',
    ...
    content:
      'We may send appointment reminders, treatment updates, and platform announcements via email or SMS. You may manage notification preferences from your account settings. Transactional messages related to your care cannot be disabled while your account remains active.',
  },
  {
    id: 'third-party',
    ...
    content:
      'To deliver a seamless experience, we integrate with trusted laboratory management systems, insurance verification providers, and imaging software. Each integration is governed by data-processing agreements ensuring the same level of protection applied to your data within our platform.',
  },
];
...
//   const { theme } = useTheme();
  ...
  const handleAgree = async () => {
    ...
    // Replace with actual consent submission / navigation
        ...
        <Row className="g-0 consent-row">
          ...
          <Col lg={5} className="d-none d-lg-flex consent-panel">
            <div className="consent-panel-inner">
              <div className="consent-panel-logo">
                <KiduLogo />
              </div>
              ...
              <div className="consent-panel-text animate-fade-in">
                ...
                <p className="panel-subtext">
                  Take a moment to understand how we handle your information before you proceed.
                </p>
              </div>
          ...
          <Col lg={7} className="d-flex align-items-center justify-content-center consent-form-col">
            <div className="consent-card animate-fade-in">
              ...
              <div
                ref={scrollRef}
                className={`consent-scroll-area ${scrolledToBottom ? 'scrolled' : ''}`}
              >
              ...
              <div className={`consent-actions ${scrolledToBottom ? 'visible' : ''}`}>
                ...
                {!scrolledToBottom && (
                  <p className="scroll-warning">
                    Please scroll through all sections to enable the agree button.
                  </p>
                )}
              </div>
