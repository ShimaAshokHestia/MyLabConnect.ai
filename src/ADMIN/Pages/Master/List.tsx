...
const columns: KiduColumn[] = [
  ...
  { key: "description", label: "Description", enableSorting: true, enableFiltering: true },
  { key: "isActive", label: "Status", type: "badge", enableFiltering: true, filterType: "select", filterOptions: ["Active", "Inactive"], render: (value) => <span className={`kidu-badge kidu-badge--${value ? "active" : "inactive"}`}>{value ? "Active" : "Inactive"}</span> },
