...
// ============================================
// 1. ADMIN CONNECT CONFIGURATION
// ============================================

export const adminConnectConfig = {
  menuItems: [
    {
      title: 'Dashboard',
      url: '/admin/dashboard',
    ...
    },
    {
      ...
      icon: Building2,
      children: [
        { title: 'Practices', url: '/admin/practices', icon: Building2 },
        { title: 'Labs', url: '/admin/labs', icon: Microscope },
        { title: 'DSOs', url: '/admin/dsos', icon: Users },
      ],
    },
    {
      title: 'Reports',
      icon: FileText,
      children: [
        { title: 'System Reports', url: '/admin/reports/system', icon: FileBarChart },
        { title: 'Revenue Reports', url: '/admin/reports/revenue', icon: DollarSign },
        { title: 'Activity Logs', url: '/admin/reports/logs', icon: FileText },
      ],
    },
    {
      title: 'Settings',
